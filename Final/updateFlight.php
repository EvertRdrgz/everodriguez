...
?>
        ...
        <form>
            ...
            Date: <input type="text" name="date" size = 20 value="<?=$flight['flight_date']?> "><br><br>
            Location: <input type="text" name="site" size = 40 value="<?=$flight['flight_site']?> "><br><br>
            Rocket Name: <br><input type="text" name="name" size = 5 value="<?=$flight['flight_rocket_name']?> "><br><br>
            Rocket Type: <br><input type="text" name="type" size = 5 value="<?=$flight['flight_rocket_type']?> "><br><br>
